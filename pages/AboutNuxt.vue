<template>
  <div class="container my-8">
    <h1 class="mb-8 text-3xl font-semibold text-primary">About Page Nuxt</h1>
    <div class="mx-auto max-w-xl lg:max-w-5xl">
      <div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        <div class="lg:pl-20">
          <div class="max-w-xs px-2.5 lg:max-w-none">
            <img src="https://placehold.jp/3d4070/ffffff/400x400.png" class="aspect-square rotate-3 rounded-2xl bg-zinc-100 object-cover dark:bg-zinc-800" />
          </div>
        </div>
